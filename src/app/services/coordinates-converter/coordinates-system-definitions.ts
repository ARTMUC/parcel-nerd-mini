export const coordSystemDefinitions = [
  ...
  {
    label: 'PULKOVO / POLSKA STREFA III',
    name: 'EPSG:2173',
    definition:
  ...
  {
    label: 'PULKOVO / POLSKA STREFA II',
    name: 'EPSG:2172',
    definition:
